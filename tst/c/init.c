...
static int genasgn(Tree, struct structexp *);
static void genchar(Symbol, struct structexp *);
static void genspace(int, struct structexp *);
static int initarray(int, Type, int);
static int initchar(int, Type);
static void initend(int, char []);
static int initfields(Field, Field);
static int initstruct(int, Type, int);
static Tree initvalue(Type);
