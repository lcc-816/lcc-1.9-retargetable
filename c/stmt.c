...
static void caselabel(struct swtch *, int, int);
static void cmp(int, Symbol, int, int);
static void dostmt(int, struct swtch *, int);
static int foldcond(Tree, Tree);
static void forstmt(int, struct swtch *, int);
static void ifstmt(int, int, struct swtch *, int);
static Symbol localaddr(Tree);
static void stmtlabel(char *);
static int swcode(struct swtch *, int *, int, int, int);
static void swgen(struct swtch *);
static void swstmt(int, int, int);
static void visit(struct equate *);
static void whilestmt(int, struct swtch *, int);
