...
static Tree addnode(int, Tree, Tree);
static Tree andnode(int, Tree, Tree);
static Type binary(Type, Type);
static Tree cmpnode(int, Tree, Tree);
static int compatible(Type, Type);
static Tree mulnode(int, Tree, Tree);
static Tree subnode(int, Tree, Tree);
