...
extern void qsort(struct count *, int, int, int (*)(const void *, const void *));
#endif

static void acaller(char *, char *, int, int, int, struct func *);
static int compare(struct count *, struct count *);
static struct func *afunction(char *, char *, int, int, int);
static void apoint(int, char *, int, int, int);
static struct file *findfile(char *);
