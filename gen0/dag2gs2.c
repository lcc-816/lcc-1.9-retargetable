...
/* Custom Compiler backend for LCC-1.9
   Copyright (C) 2003 Toshiyasu Morita

This file is part of dag2gs2. 

dag2gs2 is free software; you can redistribute it and/or modify it under
the terms of the GNU General Public License as published by the Free
Software Foundation; either version 2, or (at your option) any later
version.

dag2gs2 is distributed in the hope that it will be useful, but WITHOUT ANY
